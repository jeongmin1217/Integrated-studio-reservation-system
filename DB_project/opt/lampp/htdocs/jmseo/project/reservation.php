  		...
  		<nav>
  			<div class='inner'>
  				<div class='nav-container'>
					...
					<p class='nav-contact1'>아래 버튼들을 통해 모든 사진관을 보거나, 카테고리별 사진관을 볼 수 있습니다. <br>또한 예약 수정/삭제도 아래 버튼을 통해 진행하시면 됩니다.</p>
  				</div>
  			</div>
  		</nav>
  		<main>
        ...
        <div class="inner">
          ...
          <?php
         	 ...
         	 if (mysqli_connect_errno()) { 
         	 	...
         	 	$sql1 = "SELECT * FROM P_STUDIO ORDER BY studio_id desc;";    
